...
resource "docker_container" "nginx" {
  ...
  # Provisionamento para configurar Proxy Reverso com HTTPS e criar usuário
...
resource "docker_container" "infra_nas" {
  ...
  # Provisionamento para instalar SSH, e criar o usuário
  provisioner "local-exec" {
    command = <<EOT
...
resource "docker_container" "glpi" {
  ...
  # Provisionamento para configurar HTTPS e criar usuário
  provisioner "local-exec" {
    command = <<EOT
...
resource "docker_container" "mariadb" {
  ...
  # Provisionamento para instalar e criar o usuário
  provisioner "local-exec" {
    command = <<EOT
